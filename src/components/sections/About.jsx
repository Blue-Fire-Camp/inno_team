        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 items-center">
          <div>
            ...
            <p className="mt-6 text-lg leading-8 text-blue-100/80">
              InnoTech is a global remote talent team built on collaboration, skill, and a focus on human engineering mindset. We believe that while AI tools can generate code quickly, they lack the true judgment needed to solve complex problems.
