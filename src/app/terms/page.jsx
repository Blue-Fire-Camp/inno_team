          ...
          <div className="prose prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                ...
                <li>Not attempt to gain unauthorized access to the Site or its systems</li>
                <li>Not upload or transmit viruses or malicious code</li>
                <li>Not harass, abuse, or defame other users</li>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4">12. Contact Forms and Communications</h2>
              <p className="text-muted-foreground leading-relaxed mb-3">
                By submitting information through our contact forms or email:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                <li>You grant us permission to contact you via email or phone</li>
                <li>You represent that the information provided is accurate and complete</li>
                <li>You agree to receive communications about our services</li>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                If any provision of these Terms of Service is deemed invalid or unenforceable, the remaining provisions shall continue in full force and effect.
              </p>
            </section>
