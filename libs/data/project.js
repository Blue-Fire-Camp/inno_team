export const projects = [
  {
    title: "PGPoetry",
    description:
      "A digital poetry platform for innovative literary expression and community sharing.",
  ...
  },
  {
    ...
    description:
      "Professional corporate presence for a leading consultancy firm, featuring service showcases and client engagement tools.",
  ...
  },
  {
    ...
    description:
      "An immersive landing page for a premium coffee brand, featuring rich visuals and smooth scrolling.",
    type: "Landing Page",
    iconName: "Layout",
  ...
  },
  {
    title: "CampNet",
    description:
      "A comprehensive networking platform designed for campus communities to connect and collaborate.",
